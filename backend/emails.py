...
def enviar_confirmacion_cliente(nombre: str, email: str, barbero: str, servicio: str, precio: str, fecha: str, hora: str):
    try:
        resend.Emails.send({
            "from": "NobleCut <onboarding@resend.dev>",
            "to": "jose12roberto17@gmail.com",
            "subject": f"✂ Cita confirmada — NobleCut Barbershop",
            "html": f"""
<!DOCTYPE html>
<html lang="es">
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <!-- HEADER -->
          <tr>
            <td style="background-color:#111111;border-radius:12px 12px 0 0;padding:40px 40px 32px;border-bottom:1px solid #1E1E1E;text-align:center;">
              <div style="display:inline-block;margin-bottom:16px;">
                <span style="color:#ffffff;font-size:26px;font-weight:900;letter-spacing:4px;text-transform:uppercase;">Noble</span><span style="color:#2563EB;font-size:26px;font-weight:900;letter-spacing:4px;text-transform:uppercase;">Cut</span>
              </div>
              <div style="width:40px;height:2px;background-color:#2563EB;margin:0 auto 16px;"></div>
          ...
          <!-- HERO CONFIRMACIÓN -->
          <tr>
            <td style="background-color:#111111;padding:40px 40px 32px;border-bottom:1px solid #1E1E1E;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <div style="display:inline-block;background-color:#2563EB;width:52px;height:52px;border-radius:50%;text-align:center;line-height:52px;margin-bottom:20px;">
                    ...
                    <p style="color:#9CA3AF;font-size:14px;line-height:1.7;margin:0;">Hola <strong style="color:#ffffff;">{nombre}</strong>, tu reserva ha sido agendada exitosamente. Te esperamos en NobleCut Barbershop.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <!-- DETALLES DE CITA -->
          <tr>
            <td style="background-color:#111111;padding:0 40px 32px;border-bottom:1px solid #1E1E1E;">
              <div style="background-color:#0A0A0A;border:1px solid #252525;border-radius:10px;overflow:hidden;">

                <div style="background-color:#2563EB;padding:14px 20px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="padding:8px 20px;">
                  ...
                  <tr>
                    ...
                    <td style="color:#2563EB;padding:14px 0;font-size:20px;font-weight:900;text-align:right;">{precio}</td>
                  </tr>
                </table>
              </div>
            </td>
          ...
          <tr>
            <td style="background-color:#111111;padding:0 40px 32px;border-bottom:1px solid #1E1E1E;">
              <div style="background-color:#0A0A0A;border-left:3px solid #2563EB;border-radius:0 8px 8px 0;padding:16px 20px;">
          ...
          <!-- FOOTER -->
          <tr>
            <td style="background-color:#0A0A0A;border-radius:0 0 12px 12px;padding:28px 40px;text-align:center;border-top:1px solid #1E1E1E;">
              <p style="color:#4B5563;font-size:12px;margin:0 0 6px;">Liberia, Guanacaste, Costa Rica</p>
              <p style="color:#4B5563;font-size:12px;margin:0 0 6px;">+506 8888-8888 &nbsp;·&nbsp; @NobleCtPremium</p>
              <p style="color:#374151;font-size:11px;margin:16px 0 0;letter-spacing:2px;text-transform:uppercase;">© 2026 NobleCut Barbershop</p>
            </td>
          </tr>
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <!-- HEADER -->
          <tr>
            <td style="background-color:#111111;border-radius:12px 12px 0 0;padding:32px 40px;border-bottom:1px solid #1E1E1E;text-align:center;">
              <span style="color:#ffffff;font-size:22px;font-weight:900;letter-spacing:4px;text-transform:uppercase;">Noble</span><span style="color:#2563EB;font-size:22px;font-weight:900;letter-spacing:4px;text-transform:uppercase;">Cut</span>
              <p style="color:#2563EB;font-size:11px;letter-spacing:3px;text-transform:uppercase;margin:12px 0 0;">Nueva Reserva Recibida</p>
            </td>
          </tr>

          <!-- DATOS DEL CLIENTE -->
          <tr>
            <td style="background-color:#111111;padding:32px 40px;border-bottom:1px solid #1E1E1E;">
          ...
          <tr>
            <td style="background-color:#111111;padding:0 40px 32px;border-bottom:1px solid #1E1E1E;">
              ...
              <div style="background-color:#0A0A0A;border:1px solid #252525;border-radius:10px;overflow:hidden;">
                ...
                <div style="background-color:#2563EB;padding:12px 20px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="padding:8px 20px;">
                  ...
                  <tr>
                    ...
                    <td style="color:#2563EB;padding:12px 0;font-size:18px;font-weight:900;text-align:right;">{precio}</td>
                  </tr>
                </table>
              </div>
            </td>
          ...
          <!-- FOOTER -->
          <tr>
            <td style="background-color:#0A0A0A;border-radius:0 0 12px 12px;padding:24px 40px;text-align:center;border-top:1px solid #1E1E1E;">
              <p style="color:#374151;font-size:11px;margin:0;letter-spacing:2px;text-transform:uppercase;">NobleCut Admin · Panel de Reservas</p>
            </td>
          </tr>
