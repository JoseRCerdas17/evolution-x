    ...
    <section className="min-h-screen bg-dark relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex items-center relative pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full relative z-10 py-16">
          <div className="max-w-2xl">
            ...
            {/* Título */}
            <h1 className="text-white font-black uppercase leading-[0.9] text-5xl sm:text-6xl md:text-7xl lg:text-8xl">
              Tu Estilo,
            </h1>
            <h1 className="text-gold font-black uppercase italic leading-[0.9] text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-8">
              Evolucionado
            </h1>
      ...
      <div className="relative z-10 border-t border-dark-border bg-dark-card">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
          <div className="flex items-center justify-center lg:justify-start divide-x divide-dark-border">
            ...
            <div className="flex items-center gap-4 px-6 sm:px-10 py-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs tracking-[2px] uppercase mt-0.5">Google Maps</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 px-6 sm:px-10 py-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs tracking-[2px] uppercase mt-0.5">Expertos</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 px-6 sm:px-10 py-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs tracking-[2px] uppercase mt-0.5">Clientes</p>
              </div>
            </div>
